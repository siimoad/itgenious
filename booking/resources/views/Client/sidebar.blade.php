                            ...
                            <div class="row">
                                <div class="col form-group">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Name') }}" type="text" name="name" value="{{ old('name', auth()->user()->name) }}"  autofocus>
                                    </div>
                                    @if ($errors->has('name'))
                            ...
                            <div class="row">
                                <div class="col form-group">
                                    <div class="input-group input-group-alternative mb-3">
                                        <div class="input-group-prepend">
                                            ...
                                            <input class="form-control" name="date_naissance" type="date" value="{{ old('date_naissance', auth()->user()->date_naissance) }}" >
                                    </div>
                                ...
                                <div class="col form-group">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <select type="text" class="form-control" name = "ville" id="ville"  class="form-control{{ $errors->has('ville') ? ' is-invalid' : '' }} value="{{ auth()->user()->sexe }}"  autocomplete="ville" autofocus">
                            ...
                            <div class="row">
                                <div class="col form-group">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <select type="text" class="form-control" name = "etablissement" id="etablissement"  class="form-control{{ $errors->has('etablissement') ? ' is-invalid' : '' }} value="{{ old('name', auth()->user()->etablissement) }}"  autocomplete="etablissement" autofocus"> 
                                ...
                                <div class="col form-group">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <select type="text" class="form-control" name = "niveau" id="niveau"  class="form-control{{ $errors->has('niveau') ? ' is-invalid' : '' }} value="{{ old('niveau') }}"  autocomplete="niveau" autofocus"> 
                            ...
                            <div class="row">
                                <div class="col form-group">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <input class="form-control{{ $errors->has('tel') ? ' is-invalid' : '' }}" placeholder="{{ __('Tel') }}" type="tel" name="tel" value="{{ old('tel' , auth()->user()->tel) }}" >
                                    </div>
                                    @if ($errors->has('tel'))
                                        <span class="invalid-feedback" style="display: block;" role="alert">
                                ...
                                <div class="col form-group">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <input class="form-control" placeholder="{{ __('Email') }}" type="email" name="email" value="{{ auth()->user()->email }}"  disabled>
                                    </div>
