@extends('layouts.app', ['title' => __('Modifier Annonce')])
                ...
                <div class="card shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="col-12 mb-0">{{ __('Modifier Annonce') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                    <form method="post" action="{{route('annonce.update',['id' => $annonce->id])}}" autocomplete="off" enctype="multipart/form-data">
                          @csrf
                            @if (session('status'))
